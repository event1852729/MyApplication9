...
public class Detail_fixrecord_managerrecycle extends RecyclerView.Adapter<Detail_fixrecord_managerrecycle.Myholder> {
    static Context context;
    static ArrayList<Detail_fixrecord_item_model> list_dicuss_item_model;

    public Detail_fixrecord_managerrecycle(Context context, ArrayList<Detail_fixrecord_item_model> list_dicuss_item_model ) {
    ...
    @Override
    public Detail_fixrecord_managerrecycle.Myholder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final Detail_fixrecord_managerrecycle.Myholder holder, int position) {
        Detail_fixrecord_item_model  detail_app_item_model= list_dicuss_item_model.get(position);
        holder.fa_splace.setText(detail_app_item_model.getFixrecord_space());
        holder.fa_number.setText(detail_app_item_model.getFixrecord_name());
    ...
    public static class Myholder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public Myholder(View itemView ,  MyViewHolderClick myViewHolderClick) {
            ...
            fa_number = (TextView)itemView.findViewById(R.id.detail_fixrecord_recycle_item_numbernametext) ;
