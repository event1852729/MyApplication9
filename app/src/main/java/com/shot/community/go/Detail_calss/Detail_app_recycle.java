...
public class Detail_app_recycle extends RecyclerView.Adapter<Detail_app_recycle.Myholder> {
    static Context context;
    static ArrayList<Detail_app_item_model> list_dicuss_item_model;

    public Detail_app_recycle(Context context, ArrayList<Detail_app_item_model> list_dicuss_item_model ) {
    ...
    @Override
    public Detail_app_recycle.Myholder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.detail_appointment_recycle_item , parent ,false);
    ...
    @Override
    public void onBindViewHolder(final Detail_app_recycle.Myholder holder, int position) {
        ...
        if(detail_app_item_model.getFa_status().equals("0"))
        {
            holder.fa_status.setText("未審核");
            holder.fa_systemdate.setText(detail_app_item_model.getFa_apply_date2());
        }
        if(detail_app_item_model.getFa_status().equals("1"))
        {
