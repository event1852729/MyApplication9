...
import com.shot.community.go.Add_home_photo;
...
public class add_photo extends AppCompatActivity {
    ...
    String ServerUploadPath ="http://140.136.155.79/photo/register_finish.php" ;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_photo_new);
        ...
        clickButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(flag==0)
                {
                    Toast.makeText(add_photo.this , "請選擇照片" , Toast.LENGTH_LONG).show();
                }else if(flag==1)
        ...
        selectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    if (ContextCompat.checkSelfPermission(add_photo.this,
                            Manifest.permission.CAMERA)
                            != PackageManager.PERMISSION_GRANTED) {

                        if (ActivityCompat.shouldShowRequestPermissionRationale(add_photo.this,
                                Manifest.permission.CAMERA)) {


                        } else {
                            ActivityCompat.requestPermissions(add_photo.this,
    ...
    public void ImageUploadToServerFunction(){
        ...
        Toast.makeText(add_photo.this,"編碼中",Toast.LENGTH_LONG).show();
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = new ProgressDialog(add_photo.this );
                progressDialog.setProgressDrawable(getDrawable(R.drawable.button_dilog));

                progressDialog = ProgressDialog.show(add_photo.this,ss1,ss2,false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(add_photo.this,"新增成功",Toast.LENGTH_LONG).show();
                finish();
            }

            @Override
            protected String doInBackground(Void... params) {
                add_photo.ImageProcessClass imageProcessClass = new add_photo.ImageProcessClass();
                ...
                try {
                    String postString = URLEncoder.encode("image_path","UTF-8")+"="+URLEncoder.encode(ConvertImage,"UTF-8")+"&"+
                            URLEncoder.encode("ab_id","UTF-8")+"="+URLEncoder.encode(abid,"UTF-8");
