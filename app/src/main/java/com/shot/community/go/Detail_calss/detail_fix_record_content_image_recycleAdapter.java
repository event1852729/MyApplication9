...
import com.shot.community.go.Package_calss.Look_image;
...
public class detail_fix_record_content_image_recycleAdapter extends RecyclerView.Adapter<detail_fix_record_content_image_recycleAdapter.MyViewholder>{
    static ArrayList<String> package_image;
    static Context context;
   static String ss="";

    public detail_fix_record_content_image_recycleAdapter(Context context , ArrayList<String>  list) {
    ...
    public MyViewholder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyViewholder mViewHolder = new MyViewholder(view, new MyViewholder.MyViewHolderClick() {
            ...
            public void clickOnView(View v, int position) {
                ...
                intent5.putExtra("imageurl" , "http://140.136.155.79/fix/uploads/" + package_image.get(position));
    ...
    public void onBindViewHolder(MyViewholder holder, int position) {
            ss = "http://140.136.155.79/fix/uploads/" + package_image.get(position);
